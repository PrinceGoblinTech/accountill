...
const lenders = [
    { name: 'JamesRoss222 Solomon', type: 'mistnest', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
    ...
    { name: 'JamesRoss222 Solomon', type: 'trap', quantity: 20, date: new Date(), status: 'pending', dateDue: ''},
